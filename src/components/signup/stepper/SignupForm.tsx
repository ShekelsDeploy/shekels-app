...
export const SignupForm: FC<Props> = ({ open }) => {
    ...
    const [formStep1, setFormStep1] = useState({ role: true });
    const [formStep2, setFormStep2] = useState({ name: '', lastName: '', sex: 'male', file:'' });
    ...
    function clearInputs() {
        ...
        setFormStep2({ name: '', lastName: '', sex: 'male', file:'' });
    ...
    function saveData() {
        ...
        formData.append("file", formStep2.file)
        formData.append("username", stringPury(formStep3.username));
        formData.append("password", stringPury(formStep3.password));
        formData.append("email", formStep5.email);
        formData.append("role", formStep1.role ? '1':'0');
        formData.append("name", stringPury(formStep2.name));
        formData.append("lastName", stringPury(formStep2.lastName));
        formData.append("gender", formStep2.sex);
        formData.append("street", stringPury(formStep4.street));
        formData.append("city", stringPury(formStep4.city));
        formData.append("state", stringPury(formStep4.state));
        formData.append("postalCode", stringPury(formStep4.postalCode));
        formData.append("country", stringPury(formStep4.country));
        formData.append("phone", stringPury(formStep5.phone));
